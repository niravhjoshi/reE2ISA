...
const validate = combineValidators({
    ...
    newPassword2: composeValidators(
        isRequired({ message: "Please enter password2" }),
        matchesField('newPassword1')({ message: 'Password do not match' })
    )()
})

const Account = ({ error, invalid, submitting, handleSubmit, updatePassword }) => {
    return (
        <Segment>
            ...
            <div>
                ...
                <Form onSubmit={handleSubmit(updatePassword)}>
                    ...
                    <Divider />
                    <Button size="large" disabled={invalid || submitting} positive content="Update Password" />
                </Form>
            </div>
